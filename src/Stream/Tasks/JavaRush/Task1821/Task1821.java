package Stream.Tasks.JavaRush.Task1821;
...
public class Task1821 {
    ...
    public static void main(String[] args) throws IOException {
        String filename = "engfile.txt"; // filename

        System.out.println(countChars(filename)); // print result
    }

    public static Map<String, Integer> countChars(String filename) throws IOException {
        // path to file
        Path path = Path.of(
                "workspace", "java", "module", "src", "Stream", "Tasks", "JavaRush", "Task1821", filename
        );
