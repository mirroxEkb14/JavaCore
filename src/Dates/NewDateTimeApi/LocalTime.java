...
public class LocalTime {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(timeDifference(java.time.LocalTime.of(21, 44), Duration.of(0, ChronoUnit.MINUTES)));
    ...
    public static boolean timeDifference(java.time.LocalTime userTime, Duration duration) {
