...
//        zdt.isEqual()
        ...
        java.time.ZonedDateTime zdtMoscow = java.time.ZonedDateTime.of(LocalDate.now(), java.time.LocalTime.now(), ZoneId.of("Europe/Moscow"));

        // from zone time to UTC
        java.time.ZonedDateTime zonedDateTime = java.time.ZonedDateTime.of(LocalDate.now(), java.time.LocalTime.now(), ZoneId.of("Asia/Almaty"));
